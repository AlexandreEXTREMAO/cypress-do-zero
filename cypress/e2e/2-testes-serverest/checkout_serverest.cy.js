describe ('Testes de login', () => {
    ...
    it('Adicionando todos os itens ao carrinho', () => {
        ...
        //Adicionando vários itens ao carrinho
        cy.get(':nth-child(1) > .card-body > div > [href="/minhaListaDeProdutos"] > [data-testid="adicionarNaLista"]').click()
        cy.get('[data-testid="adicionar carrinho"]').click()
        cy.get('h1').contains('Em construção aguarde')
        cy.get('[data-testid="home"]').click()
        cy.get(':nth-child(2) > .card-body > div > [href="/minhaListaDeProdutos"] > [data-testid="adicionarNaLista"]')
        cy.get('[data-testid="home"]').click()
        cy.get(':nth-child(3) > .card-body > div > [href="/minhaListaDeProdutos"] > [data-testid="adicionarNaLista"]')
        cy.get('[data-testid="home"]').click()
        cy.get(':nth-child(4) > .card-body > div > [href="/minhaListaDeProdutos"] > [data-testid="adicionarNaLista"]')
        cy.get('[data-testid="home"]').click()
        cy.get(':nth-child(5) > .card-body > div > [href="/minhaListaDeProdutos"] > [data-testid="adicionarNaLista"]')
